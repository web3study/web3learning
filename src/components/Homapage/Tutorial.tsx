    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          ...
          src="/img/ban.png"
        />
        <div className="absolute inset-0 bg-black/25 mix-blend-multiply group-hover:bg-amber-800/50 group-hover:mix-blend-multiply transition-all duration-300 rounded-xl md:rounded-2xl" />
      </div>
