      ...
      >
        {PostList.map((post) => (
          <Link key={post.name} href={post.href}>
            <li
              key={post.name}
              className="flex flex-col bg-amber-500 bg-opacity-0 hover:bg-opacity-20 rounded-xl md:rounded-2xl group py-3 transition-all duration-300"
            >
